...
st.set_page_config(page_title="Attorney Claim Prediction", layout="centered")
...
with st.form("input_form"):
    st.subheader("📝 Claimant & Claim Details")

    CLMSEX = st.selectbox("Claimant Gender", [0, 1], format_func=lambda x: "Female" if x == 0 else "Male")
    CLMINSUR = st.selectbox("Insurance Present", [0, 1], format_func=lambda x: "No" if x == 0 else "Yes")
